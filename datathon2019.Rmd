...
In this document I present my analysis of the "Health, Nutrition and Population Statistics" dataset hosted by the World Bank Group. It was compiled from an RMarkdown file `datathon2019.Rmd`. A Shiny App showing the discussed topic and other visualizations can be accessed here. All the code that I used to build both deliverables is available in my github @violetr in the health repository. 
...
You can use the shiny app to see how are all these plots change for different selected years.
